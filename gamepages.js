...
window.GAMEPAGES_DATA = {
 ...
 "new_bird-hunt": {
  "input": "joystick",
  "note": "This game reads <strong>joystick&nbsp;2</strong> — aim with <span class='kbd'>W</span> <span class='kbd'>A</span> <span class='kbd'>S</span> <span class='kbd'>D</span> and fire with <span class='kbd'>Q</span>. The arrow keys and <span class='kbd'>G</span> do nothing here, so the title screen just sits there until you press <span class='kbd'>Q</span> — verified against the ROM in this vault, joystick 1 is never read. Let fire go between shots: only a fresh press counts, which is why pressing it on the title screen or during the count-in before a round costs you nothing. Every round sends three birds past, one at a time, on paths that change each time, and gives you five shots — the five yellow cartridges in the top right. Hitting all three scores 10 points plus 5 for every cartridge still unused, two hits score 5, one scores 1, and missing all three halves your total; if that halving takes you to zero the game is over. Any key on the console keyboard pauses the round, and fire resumes it without spending a shot.",
  "history": {
