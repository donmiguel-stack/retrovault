...
window.GAMEPAGES_DATA = {
 ...
 "new_bird-hunt": {
  ...
  "keys": "j2arrows",
  "manual": {
   "text": "<h3>Playing</h3><p>Move the crosshair with the joystick and press fire to shoot, letting the fire button go between shots. Three birds appear in each round, one at a time, each on a different flight path, and you have five bullets to spend on them. A bird you hit drops out of the sky; a miss shows a short white flash where the shot went. The five yellow bullets in the top right are your ammunition — each shot takes one away, and all five come back at the start of the next round.</p><p>Every round, the first one included, opens with a two-second pause, then a buzz as the start signal, then one more second. From the second round on, that sequence begins only once the round tune has finished. The crosshair still moves while you wait, but shooting is disabled. Fire used to leave the title screen, or to resume a paused game, counts as an input rather than a shot and costs no ammunition.</p><h3>Scoring</h3><p>The total is brought up to date once all three birds in a round have finished:</p><table><tr><th>Birds hit</th><th>Result</th></tr><tr><td>0</td><td>Total halved, rounded down, and the alarm sounds</td></tr><tr><td>1</td><td>+1 point</td></tr><tr><td>2</td><td>+5 points</td></tr><tr><td>3</td><td>+10 points, plus 5 points for every bullet still unused</td></tr></table><p><strong>A perfect round is three hits with two bullets left.</strong> The first one awards 20 points, and consecutive perfect rounds double it — 40, 80, 160, 320 and on up. Any round that is not perfect breaks the streak, and the next perfect round starts again at 20. The 16-bit total saturates at 65,535. Three hits play the happy tune once; a perfect round plays it three times.</p><p>If a zero-hit round halves the score to zero, that is the end: the alarm sounds, two seconds pass, and the title screen returns.</p><h3>Pausing</h3><p>Any key on the console keyboard pauses the game. Bird movement, round timers and animation all stop while it is paused. Fire starts it again without spending a shot; let fire go before you shoot. A key held down does not pause the game a second time after it resumes — lift it and press again.</p><h3>What you see</h3><p>On a G7400 the cartridge uses the Plus graphics layer twice over: a dawn landscape on the title screen, carrying <em>AHNL66's BIRD HUNT</em> and <em>PRESS FIRE</em>, and then a separate landscape during play with a tree, shrubs and grass. On a G7000, or any console it does not recognise, you get the original black Videopac title screen and the raster-timed blue sky over green grass. The Vault boots Videopac titles with the G7400 BIOS, so the Plus version is what you see here.</p>",
   "source": "the game’s own README",
   "url": "https://github.com/Ahnl66/BIRD-HUNT#gameplay"
  },
  "note": "Aim with the <span class='kbd'>arrow keys</span>, fire with the backtick key <span class='kbd'>&#96;</span> (left hand, top-left of the keyboard). This cartridge reads <strong>joystick&nbsp;2</strong> and also watches the console keyboard, so the Vault remaps joystick 2 onto those keys on this page only. That is also why fire is not on the usual <span class='kbd'>G</span>: the game scans all six rows of the console keyboard and pauses on any key it finds down, without checking which one — and <span class='kbd'>G</span>, every other letter, <span class='kbd'>Space</span>, <span class='kbd'>.</span>, <span class='kbd'>/</span>, <span class='kbd'>-</span> and <span class='kbd'>=</span> are all real keys on that keyboard, so they freeze the crosshair instead of moving it. Let fire go between shots — only a fresh press counts. How a round runs and how the scoring works is in the Manual below, in the author's own words. If you are on a copy of the Vault downloaded before 19 September 2026 and the arrow keys do nothing here, download the Vault again — this control fix lives in the emulator, which the in-app Update deliberately never replaces.",
  "video": {
   "id": "GbsQa3yT3MQ",
   "title": "Bird Hunt — a brand new Videopac homebrew"
  },
  "history": {
   "text": "A 2026 homebrew written from scratch in Intel 8048 assembly and published on GitHub by Ahnl66 — source, build file and the author's own emulator test harness included, under the working title ArtGame that the test names still carry. Version 1.0.0, released 23 September 2026, added a Plus title screen: on a G7400 the game opens on a dawn landscape instead of the plain black Videopac title, and brought with it a streak bonus for consecutive perfect rounds. It is built to run on the real console from a PicoPac cartridge, and it knows which machine it is on — a G7400 is recognised by two opcode signatures in its Plus BIOS, and anything else falls back to blue sky over green grass. The cartridge is four standard 2 KB banks, the game itself in the last one and a slice of the background art plus a copy of the loader in each of the other three.",
   "source": "the game’s own repository",
   "url": "https://github.com/Ahnl66/BIRD-HUNT"
  }
 },
 "new_calculator": {
  "input": "keyboard"
 ...
 "new_route66": {
  ...
  "video": {
   "id": "GY389TGiyNw",
   "title": "Route 66 Europe  Magnavox Odyssey 2 HYPERSPIN NOT MINE VIDEOSProto VIDEOPAC PHILIPS VIDEOPAC"
  }
 },
 "im_atlantis": {
  "input": "joystick",
  "manual": {
   "item": "Atlantis_1983_Imagic_EU",
   "pages": 3,
 ...
 "im_demon-attack": {
  ...
  "video": {
   "id": "HeiHP93mfjQ",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Demon Attack (1983) (Imagic) Longplay"
  }
 },
 "jo_basket-bowling_pl": {
  "input": "joystick",
  "manual": {
   "item": "tenpin-bowling-basketball-eur-philips-videopac-1980",
   "pages": 12,
 ...
 "jo_chez-maxime": {
  "input": "joystick",
  "manual": {
   "item": "Chez_Maxime_198x_Jopac",
   "pages": 3,
   "source": "Chez Maxime (198x)(Jopac)"
  },
  "video": {
   "id": "FPgLPbCKPqI",
 ...
 "jo_demon-attack_pl": {
  ...
  "manual": {
   "item": "Demon_Attack_1993_Imagic",
   "pages": 6,
   "source": "Demon Attack (1993)(Imagic) - Imagic booklet, same game"
  },
  "history": {
   "text": "Written by Rob Fulop and published by Imagic in 1982. Imagic licensed it to Thomson-Brandt, who sold the Videopac in France under the Jopac name and released this version in 1983 as Demon Attack+ - the game is Imagic's, but the G7400 background graphics are exclusive to the Jopac edition, which is why it sits under Jopac here rather than under Imagic.",
   "wikiTitle": "Demon Attack",
   "url": "https://en.wikipedia.org/wiki/Demon_Attack"
  },
  "video": {
   "id": "nwctfn_mNik",
   "title": "Demon Attack+ Jopac Version | Philips Videopac / Magnavox Odyssey / G7000 / G7400 (MrVenom1974)"
  }
 },
 "jo_exojet_pl": {
  "input": "joystick",
  "manual": {
   "item": "Exojet_198x_Jopac",
   "pages": 3,
   "source": "Exojet (198x)(Jopac)"
  },
  "video": {
   "id": "7c4KGPJKnaI",
 ...
 "jo_flipper_pl": {
  "input": "joystick",
  "manual": {
   "item": "Flipper_Game_1980_Philips_en-de",
   "pages": 6,
   "source": "Flipper Game (1980)(Philips)(en-de) - same game, Philips-branded manual"
  },
  "video": {
   "id": "QT3msJJbjlE",
 ...
 "jo_le-tresor-englouti_pl": {
  "input": "joystick",
  "manual": {
   "item": "Tresor_Englouti_Le_198x_Jopac_FR",
   "pages": 3,
   "source": "Tresor Englouti, Le (198x)(Jopac)(FR)"
  },
  "video": {
   "id": "ZIgIzZJOWgo",
 ...
 "jo_moto-crash_pl": {
  "input": "joystick",
  "manual": {
   "item": "Moto-Crash_198x_Jopac",
   "pages": 3,
   "source": "Moto-Crash (198x)(Jopac)"
  },
  "video": {
   "id": "9XGTuyK6W8Q",
 ...
 "jo_syracuse": {
  ...
  "video": {
   "id": "fBWnkaDpfj0",
   "title": "Syracuse (Odyssey 2 / Videopac) complete run - 2nd Gen Journey #32"
  }
 },
 "mod_br21_fix": {
  "input": "joystick",
 ...
 "mod_01pl": {
  "input": "mixed",
  "manual": {
   "item": "Race_1978_Philips_en-de",
   "pages": 6,
   "source": "Race / Spin-out / Cryptogram (1978)(Philips)(en-de)"
  },
  "history": {
   "text": "Cartridge number 1 in the official Philips line of games for the Philips Videopac contains three games: Race, Spin-out, and Cryptogram. In the United States, it was distributed for the Magnavox Odyssey² as Speedway / Spin-out / Cryptologic.",
   "wikiTitle": "Race – Spin-out – Cryptogram",
 ...
 "mod_11pl": {
  "input": "joystick",
  "manual": {
   "item": "cosmic-conflict-eur-philips-videopac-1980",
   "pages": 24,
  ...
  "video": {
   "id": "Kb7QDYYEfcc",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Cosmic Conflict! (1978) (Videopac 11) Longplay"
  }
 },
 "mod_14fix": {
  "input": "joystick",
 ...
 "mod_19_g7400": {
  "input": "joystick",
  "manual": {
   "item": "catch-the-ball-noughts-and-crosses-eur-philips-videopac-1980",
   "pages": 24,
 ...
 "mod_20pl": {
  "input": "joystick",
  "manual": {
   "item": "Stone_Sling_1980_Philips_en-de",
   "pages": 6,
 ...
 "mod_28fix": {
  "input": "joystick",
  "manual": {
   "item": "electronic-volleyball-eur-philips-videopac-1981",
   "pages": 18,
   "source": "Electronic Volleyball (EUR)(Philips Videopac)(1981)"
  },
  "history": {
   "text": "Volleyball!, known in Europe as Videopac 28 - Electronic Volleyball, is a 1980 volleyball video game created by Ed Averett and published by Magnavox and Philips for the Magnavox Odyssey 2 also known as the Philips Videopac G7000. Players either compete with each other or a computer opponent by controlling six volleyball players simultaneously. The game received mixed reviews from critics, some of whom praised its attempt to recreate the feel of the original sport while others criticized it for being too much like Pong.",
   "wikiTitle": "Volleyball!",
   "url": "https://en.wikipedia.org/wiki/Volleyball!"
  },
  "video": {
   "id": "U95KWXplSzk",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Volleyball! (1980) (Videopac 28) Longplay"
  }
 },
 "mod_30fix": {
  "input": "joystick",
 ...
 "mod_35pl_fix": {
  "input": "joystick",
  "manual": {
   "item": "electronic-billiards-eur-philips-videopac-1981",
   "pages": 24,
   "source": "Electronic Billiards (EUR)(Philips Videopac)(1981)"
  },
  "video": {
   "id": "1c4VL8be2XM",
 ...
 "mod_36fix": {
  "input": "joystick",
  "manual": {
   "item": "electronic-soccer-electronic-ice-hockey-eur-philips-videopac-1981",
   "pages": 28,
   "source": "Electronic Soccer | Electronic Ice Hockey (EUR)(Philips Videopac)(1981)"
  },
  "video": {
   "id": "B8s5zSQDGDg",
 ...
 "mod_43pl": {
  "input": "joystick",
  "manual": {
   "item": "pickaxe-pete-eur-philips-videopac-1982",
   "pages": 28,
 ...
 "mod_55pl": {
  ...
  "manual": {
   ...
   "pages": 4,
   "source": "Neutron Star (1983)(Philips)(EU)"
  },
  "video": {
   "id": "buF3DWJ_nPQ",
 ...
 "mod_playtag_fix": {
  ...
  "video": {
   "id": "0WQ1hcMF-_8",
   "title": "Play Tag (PROTOTYPE!) for the Philips Videopac"
  }
 },
 "mod_tutankham_fix": {
  "input": "joystick",
  "video": {
   "id": "6IgcEyfp8s0",
   "title": "Tutankham Videopac / Odyssey2"
  }
 },
 "o2_40": {
  "input": "keyboard",
  "manual": {
   "item": "TypeTellOdyssey21982",
   "pages": 12,
  ...
  "video": {
   "id": "r02EwfmZojU",
   "title": "Type & Tell - Magnavox Odyssey 2 The Voice, review (The No Swear Gamer)"
  }
 },
 "o2_48": {
  "input": "joystick",
  "manual": {
   "item": "power-lords-us-odyssey-2-1983",
   "pages": 8,
   "source": "Power Lords (US)(Odyssey 2)(1983)"
  },
  "video": {
   "id": "Sgeo6S_zuJI",
 ...
 "o2_30": {
  "input": "joystick",
  "manual": {
   "item": "ufogamemanualodyssey21981",
   "pages": 8,
  ...
  "video": {
   "id": "jNlu7wREuUA",
   "title": "UFO - Magnavox Odyssey 2 review (The No Swear Gamer)"
  }
 },
 "o2_06": {
  "input": "keyboard",
  "manual": {
   "item": "computer-intro-us-odyssey-2-1979",
   "pages": 28,
   "source": "Computer Intro! (US)(Odyssey 2)(1979)"
  },
  "video": {
   "id": "IDaW_g5pibM",
 ...
 "o2_19": {
  "input": "keyboard",
  "manual": {
   "item": "OutOfThisWorldHelicopterRescueOdyssey2",
   "pages": 8,
   "source": "Out of This World & Helicopter Rescue game manual Odyssey 2 (1979)"
  },
  "video": {
   "id": "e0QjOgqUXmw",
 ...
 "o2_10": {
  "input": "joystick",
  "manual": {
   "item": "computer-golf-us-odyssey-2-1978",
   "pages": 8,
  ...
  "video": {
   "id": "ZQxyaaiR7Es",
   "title": "Computer Golf! - (1978) - Odyssey 2 - gameplay HD"
  }
 },
 "o2_41": {
  "input": "joystick",
  "manual": {
   "item": "smithereens-us-odyssey-2-1982",
   "pages": 12,
   "source": "Smithereens! (US)(Odyssey 2)(1982)"
  },
  "video": {
   "id": "9fyLZvdnPgY",
 ...
 "o2_11": {
  "input": "joystick",
  "manual": {
   "item": "cosmic-conflict-us-odyssey-2-1978",
   "pages": 5,
 ...
 "o2_16": {
  ...
  "video": {
   "id": "uvr_00Qwkf4",
   "title": "Magnovox Odyssey 2 Game: Showdown in 2100 AD (1979 Magnovox)"
  }
 },
 "o2_39": {
  "input": "keyboard",
  "manual": {
   "item": "nimble-numbers-ned",
   "pages": 16,
  ...
  "video": {
   "id": "t4c9hM429t0",
   "title": "Magnavox Odyssey 2: Nimble Numbers Ned (1982) Longplay"
  }
 },
 "o2_38": {
  "input": "joystick",
  "manual": {
   "item": "sid-the-spellbinder-us-odyssey-2-1982",
   "pages": 12,
   "source": "Sid The Spellbinder (US)(Odyssey 2)(1982)"
  },
  "video": {
   "id": "W0fTUMkq3po",
 ...
 "o2_07": {
  "input": "keyboard",
  "manual": {
   "item": "matchmaker-buzzword-logix-us-odyssey-2-1978",
   "pages": 8,
 ...
 "o2_45": {
  "input": "joystick",
  "manual": {
   "item": "attack-of-the-timelord-us-odyssey-2-1982",
   "pages": 12,
  ...
  "video": {
   "id": "eFwgtqeRnCM",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Attack of the Timelord! (1982) (Videopac 51) Longplay"
  }
 },
 "o2_33": {
  "input": "keyboard",
  "manual": {
   "item": "keyboard-creations-us-odyssey-2-1981",
   "pages": 16,
   "source": "Keyboard Creations! (US)(Odyssey 2)(1981)"
  },
  "video": {
   "id": "iB1WzfXM_MM",
 ...
 "o2_43": {
  "input": "joystick",
  "manual": {
   "item": "p.-t.-barnums-acrobats-us-odyssey-2-1982",
   "pages": 12,
 ...
 "o2_35": {
  "input": "joystick",
  "manual": {
   "item": "k.-c.-munchkin-us-odyssey-2-1981",
   "pages": 16,
 ...
 "o2_21": {
  "input": "mixed",
  "manual": {
   "item": "dynastygamemanualodyssey21979",
   "pages": 8,
  ...
  "video": {
   "id": "ENcCIA9dTYs",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Dynasty! (1979) (Videopac 15) Longplay"
  }
 },
 "o2_14": {
  "input": "joystick",
  "manual": {
   "item": "invadersfromhyperspacegamemanualodyssey21978",
   "pages": 8,
   "source": "Invaders from Hyperspace game manual Odyssey 2 (1978)"
  },
  "video": {
   "id": "XeW4Jojq86Y",
 ...
 "o2_46": {
  "input": "joystick",
  "manual": {
   "item": "turtles-eur-philips-videopac-1983",
   "pages": 16,
 ...
 "o2_47": {
  "input": "joystick",
  "manual": {
   "item": "killerbeesgamemanualodyssey21983",
   "pages": 12,
 ...
 "vp_40": {
  "input": "mixed",
  "manual": {
   "item": "Four_in_1_row_1982_Philips_EU",
   "pages": 4,
   "source": "Odyssey 2 Manual: 4 in 1 Row"
  },
  "video": {
   "id": "upoIpYcwjaE",
   "title": "Odyssey 2 - 4 in 1 Row © 1982 Philips - Gameplay"
 ...
 "vp_58_12": {
  ...
  "manual": {
   ...
   "pages": 4,
   "source": "58 PLUS - Air Battle (1983)(Philips)(EU)"
  },
  "video": {
   "id": "YY6QuNVT5ZM",
 ...
 "vp_04": {
  "input": "joystick",
  "manual": {
   "item": "Air-Sea_War_1978_Philips_EU",
   "pages": 6,
  ...
  "video": {
   "id": "X3ki9AR-trY",
   "title": "Videopac #04 - Air-Sea War / Battle"
  }
 },
 "vp_03": {
  ...
  "video": {
   "id": "fx-CNnsWOOI",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Football! (1978) (Videopac 3) Longplay"
  }
 },
 "vp_48": {
  "input": "mixed",
 ...
 "vp_08": {
  "input": "joystick",
  "manual": {
   "item": "Baseball_1978_Philips_en-de",
   "pages": 6,
  ...
  "video": {
   "id": "jHbKYzHtMRs",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Baseball! (1978) (Videopac 8) Longplay"
  }
 },
 "vp_26": {
  "input": "joystick",
  "manual": {
   "item": "Basket_Game_1980_Philips_en-de",
   "pages": 6,
   "source": "Basket Game (1980)(Philips)(en-de)"
  },
  "video": {
   "id": "CtLLQftDf1c",
 ...
 "vp_30": {
  "input": "joystick",
  "manual": {
   "item": "battlefield-eur-philips-videopac-1981",
   "pages": 24,
 ...
 "vp_57": {
  "input": "joystick",
  "manual": {
   "item": "Blobbers_1983_Philips_EU",
   "pages": 4,
   "source": "Blobbers (1983)(Philips)(EU)"
  },
  "video": {
   "id": "WC0chYsRm5Y",
 ...
 "vp_17": {
  "input": "keyboard",
  "manual": {
   "item": "chinese-logic-eur-philips-videopac-1980",
   "pages": 24,
   "source": "Chinese Logic (EUR)(Philips Videopac)(1980)"
  },
  "video": {
   "id": "DAVAEVmm9ao",
 ...
 "vp_09": {
  "input": "keyboard",
  "manual": {
   "item": "Computer_Programmer_1978_Philips_EU",
   "pages": 28,
   "source": "Computer Programmer (1978)(Philips)(EU)"
  },
  "video": {
   "id": "tsLRtlqsUxU",
 ...
 "vp_29": {
  "input": "joystick",
  "manual": {
   "item": "Dambuster_1981_Philips_en-de",
   "pages": 16,
   "source": "Dam Buster (1981)(Philips)(en-de)"
  },
  "video": {
   "id": "46SY8ltwihU",
 ...
 "vp_16": {
  "input": "joystick",
  "manual": {
   "item": "Marksman_1978_Philips_en-de",
   "pages": 6,
  ...
  "video": {
   "id": "WgE0dGp_kXE",
   "title": "Magnovox Odyssey 2 Game:  Depth Charge/ Marksman (1979 N.V. Phillips)"
  }
 },
 "vp_35": {
  "input": "joystick",
 ...
 "vp_27": {
  "input": "joystick",
  "manual": {
   "item": "Electronic_Table_Football_1980_Philips_EU",
   "pages": 6,
   "source": "Electronic Table Football (1980)(Philips)(EU)"
  },
  "video": {
   "id": "B8s5zSQDGDg",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Electronic Table Soccer! (1980) (Videopac 27) Longplay"
 ...
 "vp_39": {
  "input": "joystick",
  "manual": {
   "item": "Freedom_Fighters_1982_Philips_EU",
   "pages": 4,
  ...
  "video": {
   "id": "8CUjnJSjBnQ",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Freedom Fighters! (1982) (Videopac 39) Longplay"
  }
 },
 "vp_39pl": {
  "input": "joystick",
 ...
 "vp_10": {
  "input": "joystick",
  "manual": {
   "item": "golf-eur-philips-videopac-1980",
   "pages": 24,
 ...
 "vp_14": {
  "input": "joystick",
  "manual": {
   "item": "Gunfighter_1978_Philips_en-de",
   "pages": 6,
 ...
 "vp_59_16": {
  "input": "keyboard",
  "manual": {
   "item": "59_PLUS_Helicopter_Rescue_1983_Philips_en-de",
   "pages": 6,
 ...
 "vp_13": {
  "input": "keyboard",
  "manual": {
   "item": "ive-got-your-number-usodyssey-21978",
   "pages": 8,
   "source": "I've Got Your Number! (US)(Odyssey 2)(1978)"
  },
  "video": {
   "id": "G_2yfSnnC9E",
 ...
 "vp_33": {
  "input": "joystick",
  "manual": {
   "item": "jumping-acrobats-eur-philips-videopac-1981",
   "pages": 28,
  ...
  "video": {
   "id": "l3oVdXPTF2Q",
   "title": "Videopac (Odyssey 2) - Jumping Acrobats (Kunstspringer) [Game 9] - Gameplay (plus4punk)"
  }
 },
 "vp_33alt": {
  "input": "joystick",
 ...
 "vp_52pl": {
  "input": "joystick",
  "manual": {
   "item": "killer-bees-eur-philips-videopac-1983",
   "pages": 16,
 ...
 "vp_32": {
  "input": "joystick",
  "manual": {
   "item": "a-labyrinth-game-supermind-eur-philips-videopac-1981",
   "pages": 28,
   "source": "A Labyrinth Game | Supermind (EUR)(Philips Videopac)(1981)"
  },
  "video": {
   "id": "Xz8XElZySqY",
 ...
 "vp_23": {
  "input": "mixed",
  "manual": {
   "item": "las-vegas-gambling-eur-philips-videopac-1980",
   "pages": 6,
   "source": "Las Vegas Gambling (EUR)(Philips Videopac)(1980)"
  },
  "video": {
   "id": "TEOy5nIPLzE",
 ...
 "vp_18": {
  "input": "joystick",
  "manual": {
   "item": "laser-war-eur-philips-videopac-1980",
   "pages": 24,
   "source": "Laser War (EUR)(Philips Videopac)(1980)"
  },
  "video": {
   "id": "DbAOS72ffdE",
 ...
 "vp_54": {
  "input": "joystick",
  "manual": {
   "item": "54_PLUS_Looney_Balloon_1983_Philips_en-de",
   "pages": 7,
   "source": "Loony Balloon (1983)(Philips)(en-de)"
  },
  "video": {
   "id": "GzmMpicE_Oc",
 ...
 "vp_37": {
  "input": "joystick",
  "manual": {
   "item": "Monkeyshines_1982_Philips_EU",
   "pages": 4,
  ...
  "video": {
   "id": "5qOEINltvDo",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Monkeyshines! (1981) (Videopac 37) Longplay"
  }
 },
 "vp_45": {
  "input": "keyboard",
 ...
 "vp_53": {
  "input": "joystick",
  "manual": {
   "item": "53_PLUS_Nightmare_1983_Philips_en-de",
   "pages": 8,
  ...
  "video": {
   "id": "WUlqZezZoB0",
   "title": "NIGHTMARE - 1983 survival horror game for Videopac G7000 (Odyssey2)"
  }
 },
 "vp_53pl": {
  "input": "joystick",
 ...
 "vp_56pl": {
  "input": "joystick",
  "manual": {
   "item": "56_PLUS_Norseman_1983_Philips_en-de",
   "pages": 11,
   "source": "56 PLUS - Norseman (1983)(Philips)(en-de)"
  },
  "video": {
   "id": "FOMMp5AY5n4",
 ...
 "vp_02": {
  "input": "joystick",
  "manual": {
   "item": "pairs-space-rendezvous-logic-eur-philips-videopac-1980",
   "pages": 22,
   "source": "Pairs | Space Rendezvous | Logic (EUR)(Philips Videopac)(1980)"
  },
  "video": {
   "id": "HBF_fbKmwus",
 ...
 "vp_42": {
  "input": "mixed",
  "manual": {
   "item": "QuestForTheRingsManual1981",
   "pages": 28,
  ...
  "video": {
   "id": "k-m-_11Jjf8",
   "title": "Quest For The Rings Playthrough  - The Odyssey 2 hybrid board and video game from 1981!"
  }
 },
 "vp_01": {
  "input": "mixed",
 ...
 "vp_15": {
  "input": "joystick",
  "manual": {
   "item": "Samurai_1978_Philips_en-de",
   "pages": 6,
 ...
 "vp_34": {
  "input": "joystick",
  "manual": {
   "item": "satellite-attack-eur-philips-videopac--1981",
   "pages": 20,
   "source": "Satellite Attack (EUR)(Philips Videopac+)(1981)"
  },
  "video": {
   "id": "Tqt29viIOjY",
 ...
 "vp_21": {
  "input": "mixed",
  "manual": {
   "item": "Secret_of_the_Pharaohs_1980_Philips_en-de",
   "pages": 6,
   "source": "Secret of the Pharaohs (1980)(Philips)(en-de)"
  },
  "video": {
   "id": "YOueTzbL2Ag",
 ...
 "vp_25": {
  "input": "joystick",
  "manual": {
   "item": "Skiing_1980_Philips_en-de",
   "pages": 6,
  ...
  "video": {
   "id": "Mwq5VtmlN-I",
   "title": "Magnavox Odyssey 2 - Philips Videopac: Alpine Skiing! (1979) (Videopac 25) Longplay"
  }
 },
 "vp_22": {
  "input": "joystick",
  "manual": {
   "item": "space-monster-eur-philips-videopac-1980",
   "pages": 24,
   "source": "Space Monster (EUR)(Philips Videopac)(1980)"
  },
  "video": {
   "id": "eo2v95CVihw",
 ...
 "vp_50": {
  "input": "joystick",
  "manual": {
   "item": "super-bee-eur-philips-videopac-1983",
   "pages": 28,
   "source": "Super Bee (EUR)(Philips Videopac)(1983)"
  },
  "video": {
   "id": "T7321hqO1Xg",
 ...
 "vp_46": {
  "input": "mixed",
  "manual": {
   "item": "Great_Wall_Street_Fortune_Hunt_The_19xx_Magnavox_US",
   "pages": 24,
   "source": "The Great Wall Street Fortune Hunt (19xx)(Magnavox)(US)"
  },
  "video": {
   "id": "4Wy9e5BLSao",
 ...
 "vp_47": {
  "input": "joystick",
  "manual": {
   "item": "Mousing_Cat_The_1982_Philips_en-de",
   "pages": 8,
   "source": "The Mousing Cat (1982)(Philips)(en-de)"
  },
  "video": {
   "id": "hykj8xsWtk8",
 ...
 "vp_60_16": {
  "input": "joystick",
  "manual": {
   "item": "trans-american-rally-eur-philips-videopac-1983",
   "pages": 24,
   "source": "Trans American Rally (EUR)(Philips Videopac+)(1983)"
  },
  "video": {
   "id": "7dErbkKtNCg",
 ...
 "Vp12_F": {
  ...
  "video": {
   "id": "loYjAVIlQTo",
   "title": "Prendre l'Argent et Fuir (Fra) - Odyssey 2 [MESS] [shortplay]"
  }
 },
 "pal_flashpoint": {
  "input": "joystick",
  "video": {
   "id": "p5xGrl8uPFc",
   "title": "Videopac G7400 / Flash Point 31,337"
  }
 },
 "pal_acrobats": {
  "input": "joystick",
 ...
 "pb_frogger": {
  "input": "joystick",
  "manual": {
   "item": "Frogger_1982_Parker_Brothers_EU",
   "pages": 10,
  ...
  "video": {
   "id": "cdvXm6SkWGE",
   "title": "Frogger Odyssey 2 Videopac Gameplay"
  }
 },
 "pb_popeye": {
  "input": "joystick",
  "manual": {
   "item": "Popeye_1983_Parker_Brothers_EU",
   "pages": 11,
 ...
 "pb_q-bert": {
  "input": "joystick",
  "manual": {
   "item": "Q-Bert_1983_Parker_Brothers_EU",
   "pages": 9,
   "source": "Q*Bert (1983)(Parker Brothers)(EU)"
  },
  "video": {
   "id": "fC8A8vZBawE",
 ...
 "pr_clay-pigeon_pl": {
  "input": "joystick",
  "manual": {
   "item": "62_PLUS_Clay_Pigeon_1984_Philips_EU",
   "pages": 4,
   "source": "Clay Pigeon (1984)(Philips)(EU)"
  },
  "video": {
   "id": "N4LtnZ1sdJ8",
 ...
 "pr_interpol": {
  "input": "joystick",
  "manual": {
   "item": "Interpol_1984_Philips_FR",
   "pages": 3,
   "source": "Interpol (1984)(Philips)(FR)"
  },
  "video": {
   "id": "2aKKwBK33Y8",
 ...
 "pr_martian-threat_alt": {
  ...
  "video": {
   "id": "-n1FXbzdmJE",
   "title": "Martian Threat (PROTOTYPE!) for the Philips Videopac"
  }
 },
 "pr_martian-threat": {
  "input": "joystick",
 ...
 "pr_nightfighter": {
  ...
  "video": {
   "id": "pgZrhf-ZXiI",
   "title": "Nightfighter (Euro, Prototype) - Odyssey 2 [MESS] [shortplay]"
  }
 },
 "pr_pinball": {
  "input": "joystick",
 ...
 "pr_robot-city": {
  ...
  "video": {
   "id": "fDspASB-0YQ",
   "title": "Robot City (PROTOTYPE!) for the Philips Videopac"
  }
 },
 "pr_shark-hunter": {
  "input": "joystick",
  "video": {
   "id": "7xmm7FVlxiI",
   "title": "Shark Hunter Europe  Magnavox Odyssey 2 HYPERSPIN NOT MINE VIDEOSProto VIDEOPAC PHILIPS VIDEOPAC"
  }
 },
 "pr_spiderman_alt": {
  "input": "joystick",
  "manual": {
   "item": "Spiderman_198x_Parker_Brothers_EU",
   "pages": 5,
   "source": "Spider-Man (198x)(Parker Brothers)(EU)"
  },
  "video": {
   "id": "btS0vIHpAhg",
 ...
 "br_9461": {
  ...
  "manual": {
   "item": "br_9461",
   "pages": 9,
   "source": "Bombardeio Submarino! / Tiro ao Alvo! - manual scan, odysseyclube.com"
  }
 },
 "br_9462": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9462",
   "pages": 9,
   "source": "Desafio Chinês! - manual scan, odysseyclube.com"
  }
 },
 "br_9463": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9463",
   "pages": 9,
   "source": "O Malabarista! / Jogo da Velha! - manual scan, odysseyclube.com"
  }
 },
 "br_9468": {
  "input": "joystick",
 ...
 "br_9469": {
  ...
  "manual": {
   "item": "br_9469",
   "pages": 13,
   "source": "O Gato e o Rato! - manual scan, odysseyclube.com"
  }
 },
 "br_9472": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9472",
   "pages": 9,
   "source": "Super Bee! - manual scan, odysseyclube.com"
  }
 },
 "br_9473": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9473",
   "pages": 9,
   "source": "Buraco Negro! - manual scan, odysseyclube.com"
  }
 },
 "br_9474": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9474",
   "pages": 9,
   "source": "Clay Pigeon! - manual scan, odysseyclube.com"
  }
 },
 "br_9475": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9475",
   "pages": 13,
   "source": "Comando Noturno! - manual scan, odysseyclube.com"
  }
 },
 "br_9476": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9476",
   "pages": 9,
   "source": "Balão Travesso! - manual scan, odysseyclube.com"
  }
 },
 "br_9477": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9477",
   "pages": 9,
   "source": "Barão Vermelho! - manual scan, odysseyclube.com"
  }
 },
 "br_9483": {
  "input": "joystick",
  ...
  "manual": {
   "item": "br_9483",
   "pages": 13,
   "source": "Frogger - manual scan, odysseyclube.com"
  }
 },
 "br_9484": {
  "input": "joystick",
 ...
 "br_9485": {
  ...
  "manual": {
   "item": "br_9485",
   "pages": 9,
   "source": "Q*bert - manual scan, odysseyclube.com"
  }
 },
 "br_9486": {
  "input": "joystick",
 ...
 "pc_hb_pantsmo": {
  "input": "keyboard",
  "note": "A side-scrolling platformer riffing openly on early-90s Apogee/Epic shareware trilogies, credits screen jokes included. <strong>Esc</strong> opens DOSBox's own menu, not the game's.",
  "history": {
   "source": "eviltentacle's itch.io page."
  }
 },
 "pc_hb_noudar": {
  "input": "keyboard",
 ...
 "pc_hb_eightfeet": {
  "input": "keyboard",
  "note": "A standalone side-story to Hibernated 1, from the same author. Pay-what-you-want on itch.io; still needs adding to emulator/roms.",
  "history": {
   "source": "Stefan Vogt's itch.io page (8bitgames.itch.io/eight-feet-under)."
  }
 },
 "pc_hb_lake": {
  "input": "keyboard",
 ...
 "pc_gta1": {
  ...
  "manual": {
   "item": "pc_gta1",
   "pages": 13,
   "source": "Grand Theft Auto (PC, 1997) - original printed manual, scanned copy via oldgames.sk"
  },
