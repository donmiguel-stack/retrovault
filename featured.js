...
//
// Every blurb here is an { en, nl, de, fr, pt, ja } object resolved by
// window.tx(). The "ja" text is kanji-free on purpose - hiragana with
// katakana for loanwords - because the Japanese audience for the Vault is
// young readers. Keep it that way when editing.
...
window.FEATURED_DATA = {
  ...
  featured: [
    { id: "vp_38", shot: "vp_38.jpg",
      blurb: { en: "The one Atari sued over — and the best-selling cartridge the console ever had. Press P at the select screen to draw your own maze.",
          ...
          ja: "アタリが うったえた ソフトです。この ゲームきで いちばん うれた カートリッジでも あります。せんたくがめんで P を おすと、じぶんだけの めいろを かけます。" } },
    { id: "vp_01pl", shot: "vp_01pl.jpg", clipId: "vp_01",
      blurb: { en: "Cartridge number one, and the first game in every Videopac box: a two-lane race, an overhead maze chase, and a codebreaking puzzle called Cryptogram, three in one. This is the G7400+ cut - extra graphics chip, extra scenery either side of the track.",
          ...
          ja: "カートリッジ ばんごう 1で、すべての Videopac の はこに はいっている さいしょの ゲームです。2レーンの レース、うえから みる めいろおいかけっこ、Cryptogram という あんごうパズル。この 3つが 1つに なっています。これは G7400+ の バージョンです。グラフィックチップが ふえて、コースの りょうがわに けしきも ふえました。" } },
    { id: "vp_43", shot: "vp_43.jpg",
      blurb: { en: "Philips' answer to Donkey Kong, and a genuinely hard platformer. Dig for gold, dodge the boulders, mind the pickaxe.",
          ...
          ja: "Philips が つくった Donkey Kong への こたえで、ほんとうに むずかしい アクションゲームです。きんを ほって、いわを よけて、つるはしに ちゅういしましょう。" } },
    { id: "jo_demon-attack_pl", shot: "jo_demon-attack_pl.jpg",
      blurb: { en: "Imagic's shooter, licensed to Thomson-Brandt and given G7400 backgrounds that exist nowhere else. The French got the best version.",
          ...
          ja: "Imagic の シューティングゲームです。Thomson-Brandt に ライセンスされて、ほかには ない G7400よう の はいけいが つきました。いちばん いい バージョンは フランスむけでした。" } },
    { id: "vp_52pl", shot: "vp_52pl.jpg", clipId: "o2_47",
      blurb: { en: "Ed Averett at his strangest: you are a swarm, and you eat other swarms. Nothing else on the machine plays like it.",
          ...
          ja: "Ed Averett の いちばん ふしぎな さくひんです。あなたは むれに なって、ほかの むれを たべます。この ゲームきに、こんな あそびかたの ゲームは ほかに ありません。" } },
    { id: "vp_51pl", shot: "vp_51pl.png",
      blurb: { en: "Sold as Attack of the Timelord in America, and licensed from a Gerry Anderson puppet series in Europe. One of the few cartridges written for the G7400's extra graphics chip.",
          ...
          ja: "アメリカでは Attack of the Timelord という なまえで うられ、ヨーロッパでは Gerry Anderson の にんぎょうげきから ライセンスされました。G7400 の ついかグラフィックチップの ために つくられた、すくない カートリッジの 1つです。" } }
  ],
  ...
  masterStrategy: [
    { id: "vp_42", year: 1981, fact: { en: "Most Innovative Game of 1981 — Electronic Games",
          ...
          ja: "1981ねん もっとも かくしんてきな ゲーム ― Electronic Games" },
      blurb: { en: "Ten rings are scattered through dungeons, caverns and shifting halls. Pick Warrior, Wizard, Phantom or Changeling and race a second player to find them first - the board, overlay and forty-plus tokens turn the TV into just one part of the table.",
          ...
          ja: "10この ゆびわが、ダンジョンや どうくつ、うごく ホールに ちらばっています。Warrior、Wizard、Phantom、Changeling から ひとりを えらび、もう ひとりの プレイヤーと どちらが さきに みつけるか きょうそうします。ボードと オーバーレイ、40いじょうの トークンで、テレビは テーブルの ほんの いちぶに なります。" },
      contents: [
        ...
        { en: "8 possession tokens, 23 castle-location tokens",
          ...
          ja: "しょゆうトークン 8こ、しろの ばしょトークン 23こ" },
        { en: "Hourglass",
          nl: "Zandloper",
          de: "Sanduhr",
          fr: "Sablier",
    ...
    { id: "vp_41", year: 1982, fact: { en: "Honorable mention, Best Multi-Player Game of 1982 — Electronic Games",
          ...
          ja: "1982ねん ベストマルチプレイヤーゲーム にゅうせん ― Electronic Games" },
      blurb: { en: "Risk with a video game instead of dice. Forty-three world powers, each rated for military and economic strength, and every battle is settled by playing the cartridge's own combat game rather than rolling anything.",
          ...
          ja: "さいころの かわりに ビデオゲームを つかう Risk です。43の くにが、ぐんじりょくと けいざいりょくで ランクづけされています。たたかいは さいころを ふる かわりに、カートリッジに はいっている せんとうゲームで きまります。" },
      contents: [
        { en: "Game board &amp; compartment lid",
        ...
        { en: "228 colored magnets on 6 uncut sheets",
          ...
          ja: "6まいの シートに ついた、いろつきマグネット 228こ" },
        ...
        { en: "9 uncut sheets of Power Base Unit chips (108 total)",
          ...
          ja: "Power Base Unit の チップシート 9まい(ぜんぶで 108こ)" }
      ] },
    { id: "vp_46", year: 1982, fact: { en: "Most Innovative Game of 1982 — Electronic Games",
          ...
          ja: "1982ねん もっとも かくしんてきな ゲーム ― Electronic Games" },
      blurb: { en: "Twenty-seven real companies and commodities - IBM, McDonald's, gold, bonds - with prices that move on the news and never run the same way twice. Buy low, sell high, and end the year richer than up to three opponents.",
          ...
          ja: "IBM や McDonald's、きんや さいけんなど、じっさいに ある 27の かいしゃと しょうひんが とうじょうします。ねだんは ニュースで うごき、けっして おなじ うごきかたを しません。やすく かって たかく うって、さいだい 3にんの あいてより おかねもちに なって 1ねんを おえましょう。" },
      contents: [
        { en: "Game board &amp; compartment lid",
          nl: "Speelbord &amp; vakdeksel",
          de: "Spielbrett &amp; Fachdeckel",
        ...
        { en: "7 green &amp; 7 gold margin/share tokens",
          ...
          ja: "みどりの マージン/シェアトークン 7こ &amp; きんいろの マージン/シェアトークン 7こ" },
  ...
  c64featured: [
    { id: "c64_paradroid",
      blurb: { en: "Andrew Braybrook's masterpiece: board an enemy droid, win a little logic duel for control of it, then turn its guns on the rest. Nothing on the machine feels quite this considered.",
          ...
          ja: "Andrew Braybrook の けっさくです。てきの ドロイドに のりこんで、ちいさな ろんりバトルに かって コントロールを うばい、その ぶきを ほかの てきに むけます。この マシンで、これほど よく かんがえられた ゲームは ほかに ありません。" } },
    { id: "c64_last_ninja",
      blurb: { en: "System 3's isometric adventure sold over four million copies and defined what a C64 blockbuster looked like — six loading screens, a Ben Daglish score, and puzzles that punished the impatient.",
          ...
          ja: "System 3 の アイソメトリックアドベンチャーは 400まんぼん いじょう うれて、C64 の だいヒットさくの かたちを きめました。6つの ローディングがめん、Ben Daglish の おんがく、そして せっかちな プレイヤーを ゆるさない パズルです。" } },
    { id: "c64_turrican2",
      blurb: { en: "Manfred Trenz and Chris Huelsbeck pushing the hardware to its limit in 1991 — vast scrolling worlds, a rotating beam weapon, and a soundtrack people still cover today.",
          ...
          ja: "Manfred Trenz と Chris Huelsbeck が、1991ねんに ハードの ちからを げんかいまで おしすすめました。ひろい スクロールワールド、かいてんする ビームへいき、そして いまも カバーされつづける サウンドトラックです。" } },
    { id: "c64_impossible_mission",
      blurb: { en: "\"Another visitor. Stay a while... stay forever!\" Epyx's acrobatic search through a mad scientist's lair, with speech synthesis that stunned everyone in 1984.",
          ...
          ja: "\"Another visitor. Stay a while... stay forever!\" くるった かがくしゃの アジトを アクロバットで さがしまわる Epyx の さくひんです。1984ねん、その おんせいごうせいは みんなを おどろかせました。" } },
    { id: "c64_wizball",
      blurb: { en: "Sensible Software's strangest and best: bounce an unsteerable ball across the land to collect paint and give a grey world its colour back. A two-player cat helps.",
          ...
          ja: "Sensible Software の いちばん ふしぎで、いちばん すばらしい さくひんです。あやつれない ボールを はねさせて だいちを すすみ、ペンキを あつめて はいいろの せかいに いろを もどします。2にんめの プレイヤーの ねこが てつだって くれます。" } },
    { id: "c64_ik_plus",
      blurb: { en: "Archer Maclean's three-way karate tournament — you, a rival, and a computer fighter all at once — with a bonus round batting bombs back. The high point of the genre on the 64.",
          ...
          ja: "Archer Maclean の 3にん どうじたいせんの からてトーナメントです。あなたと ライバルと コンピューターの ファイターが いっしょに たたかいます。ボーナスラウンドでは ばくだんを うちかえします。64 における この ジャンルの さいこうけっさくです。" } }
  ],
  ...
  pcfeatured: [
    { id: "pc_doom",
      blurb: { en: "id Software's 1993 shareware release redefined the genre it named — three episodes of BFG-toting carnage that ran on almost anything and got copied onto more office PCs than any game before it.",
          ...
          ja: "id Software が 1993ねんに だした シェアウェアばんは、じぶんが なづけた ジャンルそのものを つくりかえました。BFG を もった だいさんげきの 3エピソードは、ほとんどの パソコンで うごき、それまでの どの ゲームよりも おおくの オフィスの パソコンに コピーされました。" } },
    { id: "pc_prince_of_persia",
      blurb: { en: "Jordan Mechner rotoscoped his own brother's movements to make a video game character move like a person for the first time — sixty minutes on the clock, a sword, and traps built to kill you the moment you stop paying attention.",
          ...
          ja: "Jordan Mechner は じぶんの おとうとの うごきを ロトスコープして、はじめて にんげんらしく うごく ゲームキャラクターを つくりました。のこり 60ぷん、けん 1ぽん、そして ちゅういを きらした しゅんかんに ころされる トラップたちです。" } },
    { id: "pc_leisure_suit_larry",
      blurb: { en: "Al Lowe's text-parser comedy, the one Sierra kept a straight face selling — a disco-suited loser trying, and mostly failing, his way through a night out in Lost Wages.",
          ...
          ja: "Al Lowe の テキストパーサーコメディで、Sierra が まじめな かおで うっていた ゲームです。ディスコスーツを きた ダメおとこが、Lost Wages での よるを のりきろうと して、たいてい しっぱいします。" } },
    { id: "pc_keen6",
      blurb: { en: "The last of the original trilogy-of-trilogies: platforming through an alien mothership to rescue Keen's babysitter, with a Big Red Cannon prize waiting for anyone who beats it fast enough.",
          ...
          ja: "さいしょの「3ぶさく の 3ぶさく」の さいごの さくひんです。エイリアンの ぼせんを ジャンプアクションで すすんで、Keen の ベビーシッターを たすけます。はやく クリアした ひとには Big Red Cannon の ごほうびが まっています。" } },
    { id: "pc_duke_nukem",
      blurb: { en: "Before the one-liners and the 3D engine, Duke's first outing was a straightforward Apogee side-scroller — one disk, one wisecracking hero, and the template everything after it built on.",
          ...
          ja: "きまりぜりふや 3D エンジンより まえ、Duke の さいしょの さくひんは Apogee の シンプルな よこスクロールアクションでした。ディスク 1まい、くちの わるい ヒーロー 1にん。これが そのあとの すべての もとに なりました。" } },
    { id: "pc_sq4",
  ...
  homebrew: [
    { id: "new_amok", shot: "new_amok.jpg",
      blurb: { en: "The first one. John Dondzila brought Stern's Berzerk to the console in 1998, fifteen years after Philips walked away, and started everything below.",
          ...
          ja: "さいしょの 1ぽんです。John Dondzila が 1998ねんに Stern の Berzerk を この ゲームきに もってきました。Philips が てを ひいてから 15ねんごの ことで、ここから すべてが はじまりました。" } },
    { id: "new_ktaa", shot: "new_ktaa.png",
      blurb: { en: "Sören Gust, 2003, under the Xype label — and one of the first homebrews to use the Plus graphics. Widely held to be among the best games on the machine, official ones included.",
          ...
          ja: "Sören Gust が 2003ねんに Xype レーベルで つくりました。Plus グラフィックを つかった さいしょの ホームブリューの 1つです。こうしきさくを ふくめても、この マシンの さいこうの ゲームの 1つと いわれています。" } },
    { id: "new_route66", shot: "new_route66.png",
      blurb: { en: "Rafael Cardoso and René van den Enden, 2007. Four levels — day, night, desert, snow — seven black cars to run down in each, and every one faster than the last.",
          ...
          ja: "Rafael Cardoso と René van den Enden、2007ねんの さくひんです。ひる、よる、さばく、ゆきの 4つの ステージが あり、それぞれ 7だいの くろい くるまを おいかけます。くるまは かいを おうごとに はやく なります。" } },
    { id: "new_pong_all", shot: "new_pong_all.png",
      blurb: { en: "It took thirty years for this console to get a Pong. René van den Enden's makes up for it with eleven variations, from squash to tennis to the 1972 original.",
          ...
          ja: "この ゲームきに Pong が とどくまで 30ねん かかりました。René van den Enden の さくひんは、スカッシュから テニス、1972ねんの オリジナルまで、11しゅるいの バリエーションで それを うめあわせます。" } },
  ...
  c64homebrew: [
    { id: "c64_hb_c64anabalt", shot: "c64_hb_c64anabalt.png",
      blurb: { en: "RGCD's 16KB cartridge demake of Canabalt, 2012 — one button, infinite fall, and proof the C64 could still do a modern indie hit justice a decade after Philips-era rivals had all gone quiet.",
          ...
          ja: "RGCD が 2012ねんに つくった Canabalt の 16KB カートリッジばん デメイクです。ボタン 1つ、おわらない らっか。Philips の じだいの ライバルたちが しずまってから 10ねん たっても、C64 が モダンな インディーヒットを きちんと つくれる しょうこです。" } },
    { id: "c64_hb_wolfling", shot: "c64_hb_wolfling.png",
      blurb: { en: "Lazycow, one of the most prolific names in modern C64 homebrew, sends a wolf cub jumping through a tight 2019 platformer built from scratch, thirty-six years after the machine launched.",
          ...
          ja: "げんだいの C64 ホームブリューで もっとも たくさん つくっている Lazycow が、オオカミの こどもを 2019ねんの きっちりした アクションゲームで ジャンプさせます。マシンの はつばいから 36ねん たって、ぜんぶ 1から つくられました。" } },
    { id: "c64_hb_hero_is_back", shot: "c64_hb_hero_is_back.png",
      blurb: { en: "Excess and Hokuto Force built an unofficial sequel to Activision's 1984 H.E.R.O. in 2025 — same jetpack, same dynamite, brand new caverns, over four decades on.",
          ...
          ja: "Excess と Hokuto Force が、2025ねんに Activision の 1984ねんさく H.E.R.O. の ひこうしきな つづきへんを つくりました。おなじ ジェットパック、おなじ ダイナマイト、そして あたらしい どうくつです。40ねん いじょう たっての ことです。" } },
    { id: "c64_hb_luftrauserz", shot: "c64_hb_luftrauserz.png",
      blurb: { en: "Triad squeezed 2014's PC dogfighter Luftrausers onto real C64 silicon in 2017 — physics-driven plane combat the hardware was never supposed to run.",
          ...
          ja: "Triad が 2017ねんに、2014ねんの PC くうちゅうせん Luftrausers を ほんものの C64 の チップに おしこみました。ハードには うごかせる はずの なかった、ぶつりエンジンの ひこうきせんとうです。" } },
    { id: "c64_hb_bagman_strikes_back", shot: "c64_hb_bagman_strikes_back.png",
      blurb: { en: "LC-Games' 2022 tribute to the 1983 arcade platformer Bagman — a thief hauling gold up ladders, dodging guards, forty years and one homebrew scene later.",
          ...
          ja: "LC-Games が 2022ねんに おくった、1983ねんの アーケードアクション Bagman への オマージュです。どろぼうが はしごを のぼって きんを はこび、ばんにんを よけます。40ねんと 1つの ホームブリューシーンの のちの ことです。" } },
    { id: "c64_hb_grid_pix", shot: "c64_hb_grid_pix.png",
      blurb: { en: "Excess brought Picross to the C64 in 2020 — a genre the original Videopac and C64 shelves never had — later picked up for a real boxed cartridge release.",
          ...
          ja: "Excess が 2020ねんに Picross を C64 に もってきました。もともとの Videopac や C64 の たなには なかった ジャンルです。のちに ほんものの はこいり カートリッジとして はつばいされました。" } }
  ],
  ...
  pchomebrew: [
    { id: "pc_hb_gates",
      blurb: { en: "Tarjan's from-scratch first-person dungeon RPG, still getting numbered point releases years after its first one — create a party at the Guild and go find out what's down there.",
          ...
          ja: "Tarjan が 1から つくった、1にんしょう しせんの ダンジョンRPG です。さいしょの リリースから なんねんも たった いまも、ばんごうつきの アップデートが つづいています。Guild で パーティを つくって、したに ある ものを たしかめに いきましょう。" } },
    { id: "pc_hb_queens",
      blurb: { en: "Davide Bucci's steampunk-Italy text adventure, later released open source — type what you mean, and mean it precisely.",
          ...
          ja: "Davide Bucci に よる、スチームパンクな イタリアの テキストアドベンチャーです。のちに オープンソースで こうかいされました。いいたい ことを タイプして、それを せいかくに いいましょう。" } },
    { id: "pc_hb_spacecavern",
      blurb: { en: "dotmos built one cave-flyer and shipped it to five different 80s machines at once — C64, Amiga, Atari ST, Genesis, and this, the DOS cut.",
          ...
          ja: "dotmos は 1つの どうくつフライトゲームを つくり、80ねんだいの 5つの マシンに いっせいに とどけました。C64、Amiga、Atari ST、Genesis、そして この DOS ばんです。" } },
    { id: "pc_hb_noudar",
      blurb: { en: "Daniel Monteiro's first-person dungeon crawler, four years in the making and still one of the most-cited examples of what real DOS code can do today, not just look like.",
          ...
          ja: "Daniel Monteiro に よる 1にんしょう しせんの ダンジョンクローラーです。4ねん かけて つくられ、いまも「ほんものの DOS コードに なにが できるか」の れいと して よく あげられます。みため だけでは ありません。" } },
    { id: "pc_hb_disksweeper",
      blurb: { en: "Minesweeper as a broken-floppy repair job, built for the DOS Games August Jam 2022 — same rules, entirely new excuse for them.",
          ...
          ja: "こわれた フロッピーを しゅうりする しごとに した Minesweeper で、DOS Games August Jam 2022 の ために つくられました。ルールは おなじで、りゆうだけが まったく あたらしいです。" } },
    { id: "pc_hb_alienintruder",
      blurb: { en: "Juan J. Martínez's single-screen jump-and-run, released free in December 2024 — proof the scene isn't just a 90s revival, it shipped something new this week.",
          ...
          ja: "Juan J. Martínez に よる、1がめんの ジャンプアクションです。2024ねん 12がつに むりょうで こうかいされました。この シーンが 90ねんだいの リバイバルだけでは ない、いまも あたらしい ものを うみだしている しょうこです。" } }
  ],
  ...
  sponsors: [
    ...
    { name: "Your shop here",
      ...
      text: { en: "Selling Videopac cartridges, consoles or spare joysticks? This slot is for you.",
          ...
          ja: "Videopac の カートリッジや ゲームき、よぶんな ジョイスティックを うっていますか? この スペースは あなたの ためです。" },
  ...
  c64community: [
    { name: "CSDb",
      ...
      what: {
        ...
        ja: "シーンじしんの データベースです。1982ねん いこう この マシンよう に つくられた、ほとんど すべての ソフトの はつばいじょうほう、スクリーンショット、れきしが あります。この たなに ある 2020ねんだいの ホームブリューも いくつか ふくまれています。"
      } },
    { name: "GameBase64",
      tint: "#2fb47c",
      ...
      what: {
        ...
        ja: "しょうひんゲームを もれなく あつめた カタログプロジェクトです。この たなの C64 の ROM と カバーアートの おおくは、ここから きています。"
      } },
    { name: "Lemon64",
      tint: "#e0865a",
      ...
      what: {
        ...
        ja: "もっとも ふるく、もっとも かつどうてきな えいごの C64 コミュニティの 1つです。レビュー、はこの スキャン、そして 2000ねんから つづく フォーラムが あります。"
      } },
    { name: "C64-Wiki",
      tint: "#c07de0",
      ...
      what: {
        ...
        ja: "コミュニティが うんえいする ひゃっかじてんで、ハード、ソフト、シーンの れきしを きじごとに まとめています。"
      } },
    { name: "Protovision",
      tint: "#e0c05a",
      ...
      what: {
        ...
        ja: "いまも あたらしい じつぶつの C64 カートリッジと ハードを はつばいしつづけています。この マシンが ほんとうには とまっていない しょうこです。"
      } },
    { name: "usebox.net",
      tint: "#e05a7e",
      ...
      what: {
        ...
        ja: "Juan J. Martínez が ひとりで やっている スタジオで、いまも ほんものの ネイティブな C64、DOS、MSX、CPC、Spectrum の ゲームを つくり、Creative Commons で むりょう こうかいしています。この たなの Rescuing Orc も かれの さくひんです。"
      } },
    { name: "VICE",
      tint: "#4fb3bf",
  ...
  pccommunity: [
    { name: "VOGONS",
      ...
      what: {
        ...
        ja: "インターネットで いちばん おおきくて かつどうてきな DOS と れきしてきな パソコンハードの フォーラムです。2003ねんから、ほんものの DOSBox せってい と ほんものの 486 を、おなじ スレッドで なおしています。"
      } },
    { name: "DOSGames.com",
      tint: "#2fb47c",
      ...
      what: {
        ...
        ja: "1998ねんから つづく、むりょうの DOS ゲーム ダウンロードと レビューの サイトです。まさに この シーンを あつかう、かつどうてきな ホームブリューさっか コーナーも あります。"
      } },
    { name: "DOS haven",
      tint: "#e0865a",
      ...
      what: {
        ...
        ja: "あたらしい DOS ソフトの はつばいだけに しぼった ブログと データベースです。この たなの ホームブリューの えらびかたは、どこよりも ここに たよっています。"
      } },
    { name: "Cyningstan DOS Games",
      ...
      what: {
        ...
        ja: "いまも 8088/CGA じだいの オリジナル DOS ゲームを つくり、ソースコードを むりょうで こうかいする かいはつしゃです。そのうち Barren Planet と The Chambers Beneath の 2ほんが、この たなに あります。"
      } },
    { name: "DOS Games Jam",
      tint: "#c07de0",
      ...
      what: {
        ...
        ja: "くりかえし ひらかれる itch.io の ジャムグループです。まいとし 12がつの DOSember に くわえて、はる、なつ、あきの かいも あります。この たなの ホームブリューの おおくは、じっさいには ここから きていて、なかには ジャムの さんかさくひんも あります。"
      } },
    { name: "usebox.net",
      tint: "#e05a7e",
      url: "https://www.usebox.net/jjm/games/",
      ...
      what: {
        ...
        ja: "Juan J. Martínez が ひとりで やっている スタジオで、この 10ねんかん ほんものの ネイティブな DOS ゲームを つくり、Creative Commons で むりょう こうかいしています。この たなの Alien Intruder、Gold Mine Run!、The Return of Traxtor の 3ほんは、かれの さくひんです。"
      } },
    { name: "js-dos",
      tint: "#4fb3bf",
      ...
      what: {
        ...
        ja: "この たなの プレイヤーが じっさいに うごいている、オープンソースの「ブラウザの なかの DOSBox」プロジェクトです。"
      } }
  ],
  ...
  community: [
    { name: "Odyssey Clube",
      ...
      what: {
        ...
        ja: "ブラジルはんの ソフトです。はこの スキャン、せつめいしょ、ざっし、そして ここの ページで つかわれている ゲームの せつめいが あります。"
      } },
    { name: "The Odyssey² Homepage",
      ...
      what: {
        ...
        ja: "William Cassidy の データベースです。ちいきごとの すべての カートリッジが のっていて、しさくひんや うわさは はつばいさくと ていねいに わけられています。"
      } },
    { name: "Videopac.nl",
      tint: "#e0865a",
      ...
      what: {
        ...
        ja: "ながく つづく ファンサイトと フォーラムで、Jopac シリーズと フランスの げんていさくについての さいこうの じょうほうげんです。"
      } },
    { name: "Videopac.org",
      tint: "#c07de0",
      ...
      what: {
        ...
        ja: "カートリッジの バリエーション、はこの ばんごう、パッケージを まとめた コレクターむけの データベースです。"
      } },
    { name: "Internet Archive — Odyssey² manuals",
      ...
      what: {
        ...
        ja: "ヴォールトの すべての せつめいしょリーダーの もとに なっている、スキャンされた せつめいしょの コレクションです。"
      } },
    { name: "Rafael Cardoso — Jogos Odyssey",
      ...
      what: {
        ...
        ja: "Route 66 の さくしゃで、いまも この ゲームきむけに ゲームを つくり、できるたびに とうこうしています。じぶんの プロジェクトの どうがが 100ぽん いじょう あります。"
      } },
    { name: "webretro",
      tint: "#4fb3bf",
      ...
      what: {
        ...
        ja: "ここの ゲームを うごかしている、libretro の ブラウザフロントエンドです。BinBashBanana に よる さくひんです。"
      } },
    { name: "videopac.ch",
      tint: "#8a8f98",
      ...
      what: {
        ...
        ja: "スイスの コレクターが、じぶんの はこいり ソフトを スキャンして シェアして くれました。この ヴォールトの おまけコーナーに ある、ドイツごの Conquest of the World と Quest for the Rings の せつめいしょ、そして Wall Street Fortune Hunt の せつめいしょに ついている たげんご ようごしゅうの もとです。"
      } }
  ]
};
