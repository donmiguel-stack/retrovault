 ...
 * (unchanged when the store moved from Lemon Squeezy to Stripe - only the
 *  four license_* functions behind it did)
...
try {
    ...
    $product['game_id'] = $game;   // so a key for another game can't open this one
